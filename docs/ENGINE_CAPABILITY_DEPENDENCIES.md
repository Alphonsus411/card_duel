...
| `CAP-TIME-002` — Mulligan decreciente | PARTIAL | CAP-TIME-001, CAP-SECRET-002 | CAP-TIME-003 | **HIGH** — legalidad/resultado incorrecto que contamina capacidades posteriores | `domain/enums.py`, `domain/models.py`, `engine/phases.py`, `engine/stack.py`, `engine/actions.py` |
